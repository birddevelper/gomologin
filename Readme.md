...
Gologin is easy to setup Go login manager. It helps you protect your application resources from unattended/unauthenticated access. Currently it works with SQL databases authentication.
